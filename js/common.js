...
if ( $(this).scrollTop() > 300 && $menu.hasClass("default") ){
	...
	//кнопка sandwich
	$(".btn-sandwich_catalog").click(function() {
	...
	$('.slider-nav').slick({
		...
		touchThreshold: 1000,
		focusOnSelect: true,
		prevArrow: '<div class="slick-prev slick-arrow"><i class="fas fa-arrow-up"></i><div/>',
		nextArrow: '<div class="slick-next slick-arrow"><i class="fas fa-arrow-down"></i><div/>',
		responsive: [
		{
			breakpoint: 992,
			settings: {
